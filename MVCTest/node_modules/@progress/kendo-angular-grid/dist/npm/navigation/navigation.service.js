 ...
 * @hidden
 */
var NavigationViewport = (function () {
...
var NavigationService = (function () {
    ...
    NavigationService.prototype.init = function (meta) {
        ...
        var onStable = function () { return _this.zone.isStable ?
            Observable_1.Observable.from([true]) :
            _this.zone.onStable.take(1); };
        this.cursor.changes
            .takeWhile(isAlive)
        ...
        this.domEvents.focus
            .takeWhile(isAlive)
            .switchMap(onStable, function (args) { return args; })
            .subscribe(function (args) { return _this.navigateTo(args.target); });
        this.domEvents.focusOut
            .takeWhile(isAlive)
            .filter(function () { return _this.mode !== 0 /* Standby */; })
            .switchMap(onStable, function (args) { return args; })
            .subscribe(function (args) {
        ...
        this.editService.changes
            .takeWhile(isAlive)
            .filter(function (e) { return e.action !== 'edit' && _this.mode === 2 /* Content */; })
            .switchMap(onStable, function (args) { return args; })
        ...
        this.domEvents.keydown
            .takeWhile(isAlive)
            .filter(function (args) { return args.keyCode === 9 /* tab */ && _this.mode === 2 /* Content */; })
            .switchMapTo(this.domEvents.focusOut.take(1))
            .subscribe(function () {
