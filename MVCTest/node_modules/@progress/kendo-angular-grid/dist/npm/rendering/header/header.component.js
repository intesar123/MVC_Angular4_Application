...
var HeaderComponent = (function () {
    ...
    HeaderComponent.prototype.attachTargets = function () {
        ...
        var enterStream = this.dropTargets
            .reduce(function (acc, target) { return acc.merge(target.enter); }, Observable_1.Observable.from([]));
        var leaveStream = this.dropTargets
            .reduce(function (acc, target) { return acc.merge(target.leave); }, Observable_1.Observable.from([]));
        var dropStream = this.dropTargets
            .reduce(function (acc, target) { return acc.merge(target.drop); }, Observable_1.Observable.from([]));
        this.targetSubscription.add(enterStream
            .do(function (_a) {
            ...
            .map(function (e) { return merge(e, { before: _this.calculateBefore(e) }); })
            .map(this.normalizeTarget.bind(this))
            .do(this.enter.bind(this))
            .switchMapTo(dropStream.takeUntil(leaveStream.do(this.leave.bind(this))), function (outerArgs, _) { return outerArgs; })
    ...
    HeaderComponent.prototype.trackMove = function (leaveStream, dropStream, e) {
        ...
        if (changed && isFirst) {
            return e.draggable.drag
                ...
                return merge({ changeContainer: true }, e, { mouseEvent: mouseEvent });
            });
        }
