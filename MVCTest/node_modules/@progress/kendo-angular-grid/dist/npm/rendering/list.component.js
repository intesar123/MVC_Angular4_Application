...
var ListComponent = (function () {
    ...
    ListComponent.prototype.attachContainerScroll = function () {
        ...
        this.ngZone.runOutsideAngular(function () {
            return _this.subscriptions.add(Observable_1.Observable.fromEvent(_this.container.nativeElement, 'scroll')
                ...
                .do(function () { return _this.resetNavigationViewport(); })
                .subscribe(_this.dispatcher));
        });
        this.scrollSyncService.registerEmitter(this.container.nativeElement, "body");
        if (this.lockedContainer) {
            this.ngZone.runOutsideAngular(function () {
                _this.subscriptions.add(Observable_1.Observable.fromEvent(_this.lockedContainer.nativeElement, 'mousewheel')
                    .merge(Observable_1.Observable.fromEvent(_this.lockedContainer.nativeElement, 'DOMMouseScroll'))
                    .filter(function (event) { return !event.ctrlKey; })
                    .do(preventLockedScroll(_this.container.nativeElement))
                    .map(wheelDeltaY)
                    .subscribe(function (x) { return _this.container.nativeElement.scrollTop -= x; }));
                _this.subscriptions.add(Observable_1.Observable.fromEvent(_this.lockedContainer.nativeElement, 'keydown')
                    .filter(function (event) { return event.keyCode === 34 /* page_down */ || event.keyCode === 33 /* page_up */; })
    ...
    ListComponent.prototype.handleRowSync = function () {
        var _this = this;
        var filter = function () { return utils_1.isPresent(_this.lockedContainer); };
        return this.changeNotification.changes
            ...
            .merge(this.editService.changed)
    ...
    ListComponent.prototype.handleRowNavigationLocked = function () {
        var _this = this;
        return this.navigationService.changes
