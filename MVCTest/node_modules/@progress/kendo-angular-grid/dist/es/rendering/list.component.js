...
var ListComponent = (function () {
    ...
    ListComponent.prototype.attachContainerScroll = function () {
        ...
        if (this.lockedContainer) {
            this.ngZone.runOutsideAngular(function () {
                _this.subscriptions.add(Observable.fromEvent(_this.lockedContainer.nativeElement, 'mousewheel')
                    .merge(Observable.fromEvent(_this.lockedContainer.nativeElement, 'DOMMouseScroll'))
                ...
                _this.subscriptions.add(Observable.fromEvent(_this.lockedContainer.nativeElement, 'keydown')
    ...
    ListComponent.prototype.handleRowSync = function () {
        var _this = this;
        var filter = function () { return isPresent(_this.lockedContainer); };
