...
var HeaderComponent = (function () {
    ...
    HeaderComponent.prototype.attachTargets = function () {
        ...
        var enterStream = this.dropTargets
            .reduce(function (acc, target) { return acc.merge(target.enter); }, Observable.from([]));
        var leaveStream = this.dropTargets
            .reduce(function (acc, target) { return acc.merge(target.leave); }, Observable.from([]));
        var dropStream = this.dropTargets
            .reduce(function (acc, target) { return acc.merge(target.drop); }, Observable.from([]));
