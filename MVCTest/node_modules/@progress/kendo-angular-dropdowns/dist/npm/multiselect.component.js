...
var MultiSelectComponent = (function () {
    function MultiSelectComponent(rtl, popupService, selectionService, navigationService, cdr, differs, renderer, hostElement, _zone) {
         ...
         * ```
         */
        this.valueNormalizer = function (text) { return text.map(function (userInput) {
            var comparer = function (item) { return userInput.toLowerCase() === item.toLowerCase(); };
            if (_this.value.some(comparer)) {
                return null;
            }
    ...
    MultiSelectComponent.prototype.subscribeEvents = function () {
        ...
        [
            ...
            this.navigationService.home.filter(function () { return isClosed; }).subscribe(this.handleHome.bind(this)),
            this.navigationService.end.filter(function () { return isClosed; }).subscribe(this.handleEnd.bind(this)),
    ...
    MultiSelectComponent.prototype.removeGroupTag = function (dataItems) {
        ...
        indices.forEach(function (currentValue, index) {
            if (util_1.isNumber(currentValue)) {
                ...
                var filter = function (item) { return util_1.getter(item, _this.valueField) !== util_1.getter(dataItems[index], _this.valueField); };
                valuesToRemove.push(_this.value.find(filter));
            }
        });
    ...
    MultiSelectComponent.prototype.createCustomValueStream = function () {
        ...
        this.customValueSubscription = this.customValueSubject
            .do(function () {
            _this.loading = true;
            _this.disabled = true;
        })
            ...
            if (util_1.isPresent(normalizedValue)) {
                var newValue = _this.valuePrimitive ? util_1.getter(normalizedValue, _this.valueField) : normalizedValue;
                _this.value = _this.value.concat([newValue]);
